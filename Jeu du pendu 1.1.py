...
life = 5 #Nombre de PVs
win = False #Variable de victoire
while life != 0:  #Boucle principale

    if life ==5: #Dessin du pendu étape 1
        print("|")

    elif life ==4: #Dessin du pendu étape 2
        print("  |")
        print("(^-^)")

    elif life ==3: #Dessin du pendu étape 3
        print("  |")
        print("(^-^)")
        print(" [0]")

    elif life ==2: #Dessin du pendu étape 4
        print("  |")
        print("(^-^)")
        print(" [0]")
        print(" I I")

    elif life ==1: #Dessin du pendu étape 5
        print("  |")
        print("(^-^)")
        print(" [0]")
        print(" I I")
    ...
    if prop == 1: # /LETTRE/
        ...
        print("Apprenez à lire ! On vous demande de choisir 1 OU 2 pas autre chose ...") #Blague immature
